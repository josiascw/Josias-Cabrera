...
export default function ProductCatalog({ type }: ProductCatalogProps) {
            ...
            <div className="relative aspect-[4/5] overflow-hidden bg-gray-100">
              ...
              <div className="absolute top-4 left-4">
                <span className={`px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm ${
                  product.type === 'estilo' ? 'bg-purple-600 text-white' : 'bg-blue-600 text-white'
                }`}>
                  {product.type}
                </span>
              </div>
